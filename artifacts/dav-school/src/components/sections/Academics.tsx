...
export default function Academics() {
  ...
  return (
    <section id="academics" className="py-24 bg-primary text-white relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Comprehensive Curriculum</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {streams.map((stream, idx) => (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-sm border border-white/20 p-8 rounded-2xl hover:bg-white/15 transition-colors group"
            >
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 md:p-12 text-primary shadow-2xl"
        >
          <div className="text-center mb-10">
            <h3 className="text-3xl font-serif font-bold mb-4">The Learning Journey</h3>
          </div>
