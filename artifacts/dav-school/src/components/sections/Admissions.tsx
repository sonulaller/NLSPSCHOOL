            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="tel" className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-secondary text-white placeholder-white/40" placeholder="+91" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-white/80">Child's Class</label>
                  <select className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-secondary text-white appearance-none">
              ...
              <div>
                ...
                <textarea rows={3} className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-secondary text-white placeholder-white/40" placeholder="Any specific queries?"></textarea>
              </div>
              
              <button type="button" className="w-full bg-secondary text-white py-4 rounded-xl font-bold hover:bg-secondary/90 transition-colors mt-4">
                Submit Enquiry
              </button>
            </form>
          </motion.div>
