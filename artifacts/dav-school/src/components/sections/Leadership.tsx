          ...
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-7 space-y-6">
              ...
              <div className="space-y-4 text-white/80 text-lg leading-relaxed italic">
                <p>
                  "Education is not merely the accumulation of facts, but the preparation of life itself. At DAV Kaithal, we strive to create an environment where traditional Indian values harmonize with modern scientific thought."
                </p>
                <p>
