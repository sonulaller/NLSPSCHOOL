    ...
    <section id="about" className="py-16 sm:py-20 lg:py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-block border-b-2 border-secondary pb-1 mb-1">
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <motion.div
              ...
              className="absolute -bottom-10 -left-6 sm:-left-10 bg-white p-6 sm:p-8 rounded-2xl shadow-xl z-20 hidden md:block"
            >
              <div className="grid grid-cols-2 gap-6 sm:gap-8">
                {stats.map((stat, idx) => (
                  <div key={idx} className="space-y-1">
                    ...
                    <p className="text-[11px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider">{stat.label}</p>
                  </div>
                ))}
              </div>
            </motion.div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-6 mt-10 md:hidden">
          {stats.map((stat, idx) => (
            ...
            >
              <h3 className="text-2xl sm:text-3xl font-serif font-bold text-primary mb-1">
                <Counter to={stat.to} suffix={stat.suffix} />
              </h3>
              <p className="text-[11px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider">{stat.label}</p>
            </motion.div>
