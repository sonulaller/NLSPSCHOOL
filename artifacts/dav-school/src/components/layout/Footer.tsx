        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 border-b border-white/10 pb-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="font-serif font-bold text-lg leading-tight">NLSPS KASAN</span>
          ...
          <div>
            ...
            <form className="flex gap-2">
              ...
              <button className="bg-secondary text-white px-4 py-2 rounded-md text-sm font-bold hover:bg-secondary/90 transition-colors">Go</button>
            </form>
